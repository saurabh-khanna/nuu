...
df_final <-
  ...
  mutate(
    ...
    representation_score = log(page_perc/l1_users_perc)
  ) %>% 
  select(iso639 = iso_639, language = name, representation_score, family, region, primary_country = country, country_code, lat, lon) %>%
  arrange(representation_score)
